export type SkillCategory = "General" | "Agility" | "Strength" | "Passing" | "Mutation" | "Trait";
...
const ACCESS_BY_POSITION: Record<string, CategoryAccess> = {
  // Skaven
...
const ALL_CATEGORIES: SkillCategory[] = ["General", "Agility", "Strength", "Passing", "Mutation", "Trait"];

export function getPositionCategoryAccess(positionSlug: string): CategoryAccess {
