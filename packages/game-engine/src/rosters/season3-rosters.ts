...
export const SEASON_THREE_ROSTERS: Record<string, TeamRoster> = {
  ...
  gnome: {
    ...
    positions: [
      ...
      },
      {
        ...
        st: 2,
        ag: 2,
        pa: 0, // "-" : aucune caractéristique de passe
        av: 6,
  ...
  goblin: {
    ...
    positions: [
      ...
      },
      {
        ...
        st: 2,
        ag: 3,
        pa: 0, // "-" : aucune caractéristique de passe (No Hands)
        av: 8,
  ...
  bretonnian: {
    ...
    tier: "II",
    naf: false,
    descriptionFr: "Les Bretonniens forment une équipe de chevaliers nobles et de leurs écuyers, fidèles aux traditions chevaleresques du Vieux Monde. Rapides et courageux, ils excellent dans le jeu de passe et les charges héroïques, mais manquent de robustesse défensive.",
    descriptionEn: "The Bretonnians field a team of noble knights and their squires, faithful to the chivalric traditions of the Old World. Fast and brave, they excel at the passing game and heroic charges, but lack the defensive resilience of bashier teams.",
    positions: [
      {
        slug: "bretonnian_ecuyer_bretonnien",
        displayName: "Écuyer Bretonnien",
        cost: 50,
        min: 0,
        max: 16,
        ma: 6,
      ...
      {
        slug: "bretonnian_lanceur_chevalier",
        displayName: "Lanceur Chevalier Bretonnien",
        cost: 80,
        min: 0,
        max: 2,
        ma: 6,
      ...
      {
        slug: "bretonnian_receveur_chevalier",
        displayName: "Receveur Chevalier Bretonnien",
        cost: 85,
        min: 0,
        max: 2,
        ma: 7,
        ...
        pa: 4,
        av: 9,
        skills: "dauntless,nerves-of-steel,catch",
      },
      {
        slug: "bretonnian_chevalier_du_graal",
        displayName: "Chevalier du Graal",
        cost: 95,
        min: 0,
        max: 2,
        ma: 7,
        ...
        pa: 4,
        av: 10,
        skills: "surefoot,block,dauntless",
      }
    ],
  }
};
