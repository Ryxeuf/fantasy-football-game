...
export const SEASON_THREE_ROSTERS: Record<string, TeamRoster> = {
  ...
  bretonnian: {
    ...
    descriptionFr: "Les Bretonniens incarnent la chevalerie du Vieux Monde : derrière une piétaille d'écuyers dévoués chargent des chevaliers galvanisés par leur quête sacrée. Leur jeu mêle blocage solide et passes audacieuses, porté par l'Intrépidité de leurs nobles et des Nerfs d'acier à toute épreuve.",
    descriptionEn: "The Bretonnians embody the chivalry of the Old World: behind a rank of devoted squires charge knights spurred on by their sacred quest. Their game blends solid blocking with daring passes, carried by the Dauntless courage of their nobles and unshakeable Nerves of Steel.",
    positions: [
      {
        slug: "bretonnian_ecuyer",
