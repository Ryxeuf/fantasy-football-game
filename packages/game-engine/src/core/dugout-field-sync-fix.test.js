...
describe('Dugout Field Synchronization Fix', () => {
    it('should not show players in dugout if they are on the field', () => {
        ...
        const getReservePlayers = (allPlayers, placedPlayers, teamId) => {
        ...
        const reservePlayers = getReservePlayers(problematicState.allPlayers, problematicState.placedPlayers, 'A');
    ...
    it('should handle inconsistent placedPlayers state', () => {
        ...
        const reservePlayers = getReservePlayers(inconsistentState.allPlayers, inconsistentState.placedPlayers, 'A');
    ...
    it('should handle page refresh scenario', () => {
        ...
        const reservePlayers = getReservePlayers(pageRefreshState.allPlayers, pageRefreshState.placedPlayers, 'A');
    ...
    it('should handle mixed player states correctly', () => {
        ...
        const reservePlayers = getReservePlayers(mixedState.allPlayers, mixedState.placedPlayers, 'A');
    ...
    it('should verify the fix works with undefined pos', () => {
        ...
        const reservePlayers = getReservePlayers(undefinedPosState.allPlayers, undefinedPosState.placedPlayers, 'A');
