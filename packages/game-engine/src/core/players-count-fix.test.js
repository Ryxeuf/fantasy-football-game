...
describe('Players Count Fix', () => {
    it('should count players based on field position, not placedPlayers array', () => {
        ...
        const getPlayersOnField = (allPlayers, team) => {
    ...
    it('should show validate button when 11 players are on field', () => {
        const shouldShowValidateButton = (allPlayers, currentCoach) => {
            if (!allPlayers || !Array.isArray(allPlayers)) {
                return false;
            }
    ...
    it('should handle undefined state gracefully', () => {
        ...
        const playersOnField = getPlayersOnField(undefined, 'A');
    ...
    it('should handle null state gracefully', () => {
        ...
        const playersOnField = getPlayersOnField(null, 'A');
        expect(playersOnField).toBe(0);
    });
