...
export default function DiceTestComponent() {
  const diceResults: BlockResult[] = ['PLAYER_DOWN', 'BOTH_DOWN', 'PUSH_BACK', 'STUMBLE', 'POW'];

  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-4 text-center">Test des images de dés de blocage</h2>
        ...
        {diceResults.map((result, index) => (
          <div key={index} className="text-center p-4 border border-gray-300 rounded-lg bg-gray-50">
            ...
            <p className="text-xs text-gray-600">
              ...
              {result === 'STUMBLE' && 'Si la cible utilise Dodge, cela devient Push ; sinon, c\'est POW!'}
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• Lancez une action de blocage dans le jeu pour voir les images en action</li>
