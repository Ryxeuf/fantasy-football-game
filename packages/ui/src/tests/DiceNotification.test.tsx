...
describe('DiceNotificationDemo', () => {
  it('devrait rendre le composant de démonstration', () => {
    ...
    expect(screen.getByText('Test des Notifications de Dés')).toBeInTheDocument();
  ...
  it('devrait afficher les instructions', () => {
    ...
    expect(screen.getByText(/Cliquez sur les boutons pour tester/)).toBeInTheDocument();
    expect(screen.getByText(/Les notifications apparaîtront en haut à droite/)).toBeInTheDocument();
  });
});
