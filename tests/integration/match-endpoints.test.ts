...
const API_BASE = process.env.API_BASE || process.env.NEXT_PUBLIC_API_BASE || 'http://localhost:8201';

// Token fourni par l'utilisateur (match_token signé avec MATCH_SECRET)
const MATCH_TOKEN = process.env.MATCH_TOKEN || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtYXRjaElkIjoiY21meTVxcmptMDAwMHFwYXpwNG80dnpwaSIsInVzZXJJZCI6ImNtZnkzbDF0YTAwMDBqbDRwanprZ2Uwb3ciLCJpYXQiOjE3NTg3MzA5MDIsImV4cCI6MTc1ODczODEwMn0.tSGy_iqfQfq1T0efaVTInlIX0euyO5VikWR4XpNaFwU';
