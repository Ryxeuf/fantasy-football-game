...
describe("Test de stress - Simulation intensive", () => {
  it("devrait simuler 20 tours avec des actions aléatoires", () => {
    ...
    // exiger `x >= 0` de TOUS les joueurs faisait échouer la spec dès qu'une
    // des mi-temps simulées envoyait quelqu'un au dugout. On distingue les
    // deux cas, ce qui vérifie en plus que la sentinelle est bien celle
    // attendue (et non une coordonnée négative quelconque).
