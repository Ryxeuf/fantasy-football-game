...
| S26.2 | Notifications temps-reel achievement unlock | AMELIO | M | [~] | 38 achievements existent (4 rosters Master + milestones match/win/td/cas + 2 social) mais aucune notification visible quand debloques. Ajouter : toast in-game, son optionnel, redirect vers `/me/achievements` au clic. **EN COURS : S26.2a (backend `newlyUnlocked`), S26.2b (banner + badge "Nouveau" sur `/me/achievements`). Restant : toast in-game (lors du dernier turn d'un match) + son optionnel.** |
