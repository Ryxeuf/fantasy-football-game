# Extraction texte — Compétences et traits

> Transcription du texte visible sur les images fournies. Les passages visiblement coupés par le cadrage sont indiqués entre crochets.

## Compétences !

D’une manière générale, les Compétences sont des aptitudes qu’un joueur peut apprendre avec la pratique, des efforts et, parfois, un peu de talent. Elles sont le résultat des heures de dévouement que le joueur passe sur le terrain ou en écoutant les conseils de son coach. Eu égard à la nature du Blood Bowl, tout ceci arrive moins souvent qu’il le devrait !

Tous les joueurs ont accès à une ou plusieurs catégories de Compétence, comme stipulé dans leur profil. Certaines sont classées en Principales, c’est-à-dire les Compétences qui viennent plus naturellement au joueur en question, et d’autres en Secondaires, qui nécessitent un investissement de PSP supérieur de la part du joueur. Tous les joueurs n’ont pas accès à toutes les catégories de Compétence.

La façon dont les joueurs gagnent de nouvelles Compétences en jeu en Ligue est expliquée en page 97.

**Par exemple :** Un Blitzer des Rois des Tombes a G et F listés sous Principales, et A et S sous Secondaires. Ceci signifie qu’il a accès aux Compétences Générales et de Force en Principales, et aux Compétences d’Agilité et Scélérates en Secondaires.

La catégorie d’une Compétence, qu’il s’agisse d’Agilité, de Scélérate, de Générale, de Mutation, de Passe ou de Force, est indiquée par un des symboles suivants :

- Compétence d’Agilité
- Compétence de Force
- Compétence Générale
- Compétence de Mutation
- Compétence de Passe
- Compétence Scélérate

De plus, une Compétence d’Élite sera indiquée par ce symbole :
...
**Par Exemple :** ce Bomba a annoncé une Action Spéciale de Lancer de Bombe, et a annoncé comme cible d’une Passe Courte la case occupée par l’Écuyer Bretonnien. Le Bomba fait le Test de Capacité de Passe, obtient un 5 et donc une Passe Précise. Comme il n’y a pas de joueur adverse sous la Réglette, il n’y a pas de tentative d’Interception de la bombe et la bombe atterrit sur la case de l’Écuyer Bretonnien, qui peut tenter de la Réceptionner.

L’Écuyer Bretonnien obtient un 4 pour Réceptionner la bombe, ce qui est une réussite. Comme l’Écuyer a réceptionné la bombe, il doit immédiatement la relancer. Hélas, l’Écuyer obtient un 1 et provoque une Maladresse, si bien que la bombe explose sur sa case.

Texte du schéma : **LANCER**, **RÉCEPTION**, **LANCER**.

## Botter de Coéquipier (Passif)
...
Toutefois, si une Action Spéciale de Botter de Coéquipier résulte en une Maladresse sur Lancer, faites immédiatement un Jet de Blessure pour le coéquipier botté, en traitant tout résultat de Sonné comme K.-O. Si le joueur botté était en possession du ballon, celui-ci Rebondit depuis la case où il se trouve.
...
## Fragment visible — exemple précédent

Cette fois un 3 et se déplace comme indiqué. Comme ceci amène le Fanatique sur une case occupée par un joueur adverse, il effectue immédiatement une Action de Blocage contre lui, et obtient ici un Défenseur Plaqué. Pour le dernier point de Mouvement du Fanatique, il place le Gabarit de Renvoi à nouveau face à la Zone d’En-but adverse et obtient cette fois un 5. Le Fanatique se déplace alors sur la case d’un joueur adverse À Terre, il Repousse donc immédiatement le joueur et fait un Jet d’Armure pour lui. Si le Fanatique veut continuer de se déplacer, il doit tenter de Foncer.
...
Quand on fait un Jet de Blessure pour ce joueur, il n’est K.-O. que sur un jet de 9 ; un jet de 8 est traité comme un résultat Sonné. Si ce joueur a aussi le Trait Minus, alors il n’est K.-O. que sur un jet de 8 ; un jet de 7 sera traité comme un résultat Sonné.

## Dans le Mille (Active)
...
## Lancer de Coéquipier (Actif)

Ce joueur peut annoncer l’Action Lancer de Coéquipier comme décrit en page 76.

## Libération Contrôlée (Active)
...
Un joueur ayant ce Trait peut appliquer un modificateur de +1 au Test d’Agilité quand il tente d’Esquiver.
...
Un joueur ayant ce Trait ne peut pas abandonner volontairement le ballon quand il en est en possession, et ne peut donc pas déclarer d’Actions de Passe ni de Transmission, ni utiliser la moindre Compétence ou Trait qui l’autoriserait à renoncer à la possession du [texte coupé sur l’image].

## Passe Assurée (Active)
...
Sur un 1, le joueur devient Enraciné. Tant qu’il est Enraciné, un joueur ne peut pas effectuer d’Action de Mouvement, ne peut pas Poursuivre après avoir effectué une Action de Blocage, ne peut pas être Repoussé et ne peut en aucun cas quitter sa case actuelle, sauf s’il est mis K.-O. ou subit une Élimination.

Un joueur Enraciné cesse immédiatement d’être Enraciné à la fin d’une Phase, ou s’il est Plaqué ou Mis À Terre.

## Présence Perturbante* (Passive)
...
De plus, ce joueur peut appliquer un modificateur de +1 à ses Test d’Agilité quand il tente de Réceptionner le ballon dans le cadre d’une Action de Passe s’il est sur la case cible.

## Regard Hypnotique (Actif)
...
Si ce joueur a un Mouvement de 2 ou moins et tente de se relever, appliquez un modificateur de +1 au jet pour se relever pour chaque coéquipier Debout Démarqué adjacent à ce joueur. Un jet de 1 naturel échoue quand même normalement.

## Trois-quarts à vil prix

Certaines équipes ont si peu d’égard pour leurs trois-quarts (parfois à raison !) qu’elles ne se préoccupent pas toujours de les rémunérer. À la place, elles prennent les joueurs les plus inutiles pour gonfler leurs rangs simplement pour avoir les effectifs obligatoires. Cela convient à la plupart de ces joueurs, car ils sont d’ordinaire prêts à jouer pour des cacahuètes, et se satisfont simplement d’être là !

En Jeu en Ligue, quand une équipe ayant cette règle spéciale calcule sa Valeur d’Équipe Actuelle, traitez les Coûts d’Embauche des joueurs Trois-quarts de l’équipe comme étant de 0 pièce d’or. Toute augmentation de valeur de ces joueurs est incluse normalement.

## Maîtres de la Non-vie

Collectivement appelés “morts-vivants”, les membres de ces équipes seront souvent rejoints par des défunts récents, qui font de parfaits trois-quarts. Parfois, un Nécromancien un peu trop enthousiaste n’attendra même pas que le cadavre d’un joueur adverse soit froid pour le relever et lui faire changer de maillot avant de l’envoyer sur le terrain affronter ses anciens coéquipiers !

Une fois par match, si un joueur adverse ayant une Force de 4 ou moins et n’ayant pas le Trait Minus subit un résultat Mort lors du jet sur le Tableau d’Élimination, une équipe avec cette règle spéciale peut Relever le Mort. En ce cas, elle peut immédiatement ajouter un unique joueur Trois-quart de sa Fiche d’Équipe à son Box des Réserves. Ceci peut amener une équipe à avoir temporairement plus de 16 joueurs pour le restant du match.

À la Séquence d’Après Match, quand vous embauchez de nouveaux joueurs pour votre équipe, vous pouvez embaucher de façon permanente et gratuitement le nouveau joueur Trois-quart, tant que votre Liste d’Équipe ne compte pas déjà 16 joueurs, sinon, il est perdu. Le joueur ajoute quand même sa valeur totale à votre Valeur d’Équipe.

## Déferlement

Ces équipes sont pleines de petits joueurs prêts à tous les mauvais coups, et les tenir éloignés du terrain est plus facile à dire qu’à faire. Garder un œil sur ces petites pestes est presque impossible, et la plupart des arbitres préfèrent se montrer plus laxistes sur la règle des onze joueurs, d’autant que ces joueurs finiront rapidement réduits en purée sur le gazon ou l’astrogranite !

Pendant la Séquence de Début de Phase, après que les deux équipes ont placé leurs joueurs, une équipe avec cette règle spéciale peut placer sur le terrain D3 joueurs Trois-quarts supplémentaires depuis son Box des Réserves, selon toutes les règles normales de placement des joueurs. Ceci permet à une équipe de dépasser le maximum habituel de 11 joueurs sur le terrain.

## Capitaine

Certaines équipes pratiquent le Blood Bowl depuis si longtemps qu’une hiérarchie naturelle est apparue dans leurs rangs. Ceux qui ont plus de bouteille ont des conseils à prodiguer, ou ont suffisamment de victimes au compteur pour avoir gagné le respect de leurs coéquipiers. Quoi qu’il en soit, ces équipes adhèrent aux principes sportifs “classiques”, et les joueurs les plus aguerris les dirigent sur le terrain en portant leur emblématique, et souvent taché de sang, brassard de capitaine !

Quand vous sélectionnez une Liste d’Équipe pour une équipe avec cette règle spéciale, vous pouvez désigner n’importe quel joueur sur votre liste de départ (à l’exception d’un Gros Bras) pour qu’il soit le Capitaine de votre équipe. Un Capitaine gagne immédiatement la Compétence Pro sans augmenter son coût. De plus, si votre Capitaine est sur le terrain, chaque fois que vous utilisez une Relance d’Équipe vous pouvez jeter un D6 ; sur un jet de 6 naturel, la Relance d’Équipe est gratuite.

Lors du placement au début d’une Phase, vous devez choisir d’aligner votre Capitaine si possible. Un Capitaine peut être renvoyé de votre liste seulement s’il a subi une blessure qui a réduit une de ses caractéristiques. Toutefois, si un Capitaine est tué lors d’un match, alors vous pouvez nommer un nouveau Capitaine à la fin du match.
