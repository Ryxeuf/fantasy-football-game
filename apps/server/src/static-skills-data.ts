/**
 * Données statiques complètes des compétences extraites de apps/web/app/skills/page.tsx
 * Mapping par nameEn pour correspondre aux SKILLS_DEFINITIONS
 * 
 * Ces données seront utilisées pour remplir la base de données via le seed,
 * puis supprimées du frontend
 */
...
/**
 * Mapping complet des compétences par nameEn
 * Contient toutes les données des compétences depuis les données statiques du frontend
 */
export const STATIC_SKILLS_DATA: Record<string, StaticSkillData> = {
  // Agility Skills
  "Catch": {
    nameFr: "Réception",
    nameEn: "Catch",
  ...
  "Mighty Blow": {
    ...
    descriptionEn: "When an opposition player is Knocked Down as the result of a Block action performed by this player, you may apply a +1 modifier to either the Armour roll or Injury roll made against them.",
    category: "Strength"
  },
  "Mighty Blow (+2)": {
    nameFr: "Châtaigne (+2)",
