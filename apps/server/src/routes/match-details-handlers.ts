...
// S27.8.32 — `handleGetMatchSummary` extrait dans
// `routes/match-summary-handler.ts` (ramener ce module sous DoD
// secondaire 400). Re-export pour preserver l'API publique
// consommee par `match.ts` puis `match.test.ts`.
export { handleGetMatchSummary } from './match-summary-handler';
