...
B(Et, {
  ...
  __wbindgen_closure_wrapper7416: () => st,
...
function h() {
  return (
    (m === null || m.byteLength === 0) && (m = new Uint8Array(r.memory.buffer)),
    m
  );
}
const N =
  ...
  const _ = { a: e, b: t, cnt: 1, dtor: n },
    i = (...c) => {
      ...
      try {
        ...
        --_.cnt === 0
          ? (r.__wbindgen_export_5.get(_.dtor)(u, _.b), E.unregister(_))
          : (_.a = u);
      }
    };
...
function ct(e, t) {
  ...
  (g().setBigInt64(e + 8 * 1, l(o) ? BigInt(0) : o, !0),
    g().setInt32(e + 4 * 0, !l(o), !0));
}
function it(e) {
  const t = e;
...
0 &&
  (module.exports = {
    ...
    __wbindgen_cb_drop,
    __wbindgen_closure_wrapper7416,
