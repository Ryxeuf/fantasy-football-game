 ...
 *
 * Partagé par les coupes (`/cups/[id]/edit`) et les ligues (formulaire de
 * ligue, console admin) : les CATALOGUES de critères diffèrent, la
 * manipulation de la liste, non.
 */

/** Ajoute un critère en queue, ou le retire s'il est déjà présent. */
export function toggleRule(rules: readonly string[], slug: string): string[] {
