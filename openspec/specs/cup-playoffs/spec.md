...
Comment une coupe se termine par un bracket d'élimination directe : une ronde
par slot, des têtes de série prises dans les quotas de poule (ou dans le
classement général), une création paresseuse des tours suivants, et une
publication explicite qui garde le bracket au commissaire tant qu'il n'a pas
corrigé les têtes. Le MOTEUR de bracket est partagé avec la ligue : seul ce
qui est propre à la coupe est décrit ici.
