...
API) : un journal d'actions saisi à la main pendant une partie sur table.

Elle est DÉSACTIVÉE depuis le 2026-09-11 — pas mûre, et surtout en doublon
avec la feuille de match, qui est le chemin de saisie d'un résultat de ligue
comme de coupe. Ce qui est spécifié ici, c'est donc son GATE : ce que la
désactivation ferme, ce qu'elle laisse ouvert, et à quelles conditions la
brique se rallume.
