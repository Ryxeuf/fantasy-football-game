# roster-share-preview

## Purpose

Le partage d'une équipe par son coach, de bout en bout : l'aperçu généré par
les réseaux (Discord, Slack, X…) identifie l'équipe — logo non déformé, titre
portant le nom de l'équipe ET celui du site, texte personnalisable par le
coach — et la page publique qui s'ouvre derrière le lien (`/r/:token`) montre
...
chiffré. Sans jamais exiger de compte, ni exposer autre chose que ce que le
partage opt-in autorise.
