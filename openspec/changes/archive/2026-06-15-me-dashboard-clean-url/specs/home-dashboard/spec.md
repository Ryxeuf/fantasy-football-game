# home-dashboard (delta)

Capability : accueil web (`/`) + tableau de bord personnalise du coach
(`/me`), navigation croisee entre les deux, et conditionnement des actions
"Jouer en ligne" par feature flag.
